            ...
            for (var i = 1; i < arguments.length; i++) {
                ...
                for (var key in obj) {
                    if (obj.hasOwnProperty(key)) {
                        if (_typeof(obj[key]) === 'object') out[key] = mUtil.deepExtend(out[key], obj[key]);else out[key] = obj[key];
                    }
                }
            }
...
var mApp = function () {
    ...
    */
    var initScrollers = function initScrollers() {
        $('[data-scrollable="true"]').each(function () {
            var el = $(this);
            mUtil.scrollerInit(this, { disableForMobile: true, handleWindowResize: true, height: function height() {
    ...
    */
    var _initCustomTabs = function _initCustomTabs() {
        // init bootstrap popover
    ...
    $.fn[pluginName] = function (options) {
        ...
        var Plugin = {
            ...
            sort: function sort(field, _sort) {
                ...
                // update field and sort params
                var meta = { field: field, sort: _sort };
                Plugin.setDataSourceParam('sort', meta);

...
<head>
    ...
    <!--begin::Fonts -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700|Roboto:300,400,500,600,700|Asap+Condensed:500">

    <!--end::Fonts -->


    <!--begin::Page Vendors Styles(used by this page) -->
    <link href="{{ asset('assets/v614/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet" type="text/css" />

    <!--end::Page Vendors Styles -->

    <!--begin::Global Theme Styles(used by all pages) -->
{{--    {{ Html::style('assets/v614/js/perfect-scrollbar/css/perfect-scrollbar.css')}}--}}
    ...
    <!--begin:: Styles received from childpages -->
    @yield('css')
    <!--end:: Styles received from childpages -->
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="/">
            <img alt="{{ config('app.name') }}" src="{{ asset('assets/img/Webportal_logo_Inverted.png') }}" style="height:38px"/>
        </a>
    </div>
...
{{--{{ Html::script('assets/v614/js/perfect-scrollbar/dist/perfect-scrollbar.js')}}--}}
{{ Html::script('assets/v614/js/scripts.bundle.js')}}
<!--end::Global Theme Bundle -->

<!--begin::Page Vendors(used by this page) -->
{{ Html::script('assets/v614/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}
<!--end::Page Vendors -->

<!--begin::Page Scripts(used by this page) -->
{{ Html::script('//cdnjs.cloudflare.com/ajax/libs/jquery-form-validator/2.3.26/jquery.form-validator.min.js') }}
{{ Html::script('assets/v614/js/pages/dashboard.js') }}

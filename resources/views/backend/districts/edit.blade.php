    ...
    <div class="row">
        <div class="col-xl-8 offset-xl-2">
            <div class="m-portlet m-portlet--mobile  m-portlet--rounded">
                ...
                {!! Form::model($district, ['route'=> ['districts.update', $district->id], 'method'=>'PUT', 'class' => 'm-form m-form--fit m-form--label-align-right']) !!}
                @include('backend.districts._form')
                @include('layouts.portlets.footer._footer', ['type'=> 'edit', 'name' => 'District'])
                {!! Form::close() !!}
            </div>
        </div>
    </div>

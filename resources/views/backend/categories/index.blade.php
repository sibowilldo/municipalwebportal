                                                ...
                                                <ul class="m-nav">
                                                    ...
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('types.index') }}" class="m-nav__link">
                                                            ...
                                                            <span class="m-nav__link-text">View Types</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('statuses.index') }}" class="m-nav__link">
                                                            <i class="m-nav__link-icon la la-toggle-off"></i>
                                                            <span class="m-nav__link-text">View Statuses</span>
                                                        </a>
                                                    </li>
                                                    <li class="m-nav__separator m-nav__separator--fit"></li>
                                                    <li class="m-nav__item">
                                                        <a href="{{ route('categories.create') }}" class="btn btn-primary m-btn m-btn--wide m-btn--air btn-block btn-sm">Add Category</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>

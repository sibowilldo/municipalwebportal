                ...
                <b-form @reset="onReset" @submit.stop.prevent="onSubmitIncident" class="m-form">
                    <div class="m-portlet__body">
                        <b-form-group label="Name:" label-for="name">
                            <b-form-input id="name" size="lg" type="text" v-model.trim="form.name" :state="validateInput('name')">
                            </b-form-input>
                            <b-form-invalid-feedback
                                id="name-live-feedback"
                            >Name is a required field and must be min of 3 and max of 100 characters.</b-form-invalid-feedback>
                        </b-form-group>
                        <b-form-group label="Description:" label-for="description">
                            <b-form-textarea id="description" max-rows="6"
                                             rows="6" v-model.trim="form.description"  :state="validateInput('description')">
                            </b-form-textarea>
                            <b-form-invalid-feedback
                                id="description-live-feedback"
                            >Description is a required field and must be min of 10 and max of 500 characters.</b-form-invalid-feedback>
                        </b-form-group>
                        ...
                        <b-form-group label="Location Description:" label-for="location_description">
                            <b-form-input id="location_description" size="lg" :state="validateInput('location_description')"
                                          type="text" v-model.trim="form.location_description">
                            </b-form-input>
                            <b-form-invalid-feedback
                                id="location-description-live-feedback"
                            >Location Description is a required field and must be min of 10 and max of 255 characters.</b-form-invalid-feedback>
                        </b-form-group>
                        <b-row>
                            <b-col>
                                <b-form-group label="Longitude:" label-for="longitude">
                                    <b-form-input id="longitude" size="lg" type="text" :state="validateInput('longitude')"
                                                  v-model.trim="form.longitude">
                                    </b-form-input>
                                    <b-form-invalid-feedback
                                        id="longitude-live-feedback"
                                    >Longitude is a required .</b-form-invalid-feedback>
                                </b-form-group>
                            </b-col>
                            <b-col>
                                <b-form-group label="Latitude:" label-for="latitude">
                                    <b-form-input id="latitude" size="lg" type="text" v-model.trim="form.latitude" :state="validateInput('latitude')">
                                    </b-form-input>
                                    <b-form-invalid-feedback
                                        id="latitude-live-feedback"
                                    >Latitude is a required field.</b-form-invalid-feedback>
                                </b-form-group>
                            </b-col>
                        </b-row>
                        ...
                        <b-form-group label="Type:" label-for="type_id" :state="validateInput('type')">
                            <multiselect :close-on-select="true" :options="this.types" :searchable="true"
                                         ...
                                         v-model.trim="form.type" :disabled="this.form.category==null"></multiselect>
                        </b-form-group>
                        <b-form-group label="Status:" label-for="status_id" :state="validateInput('status')">
                            <multiselect :close-on-select="true" :options="this.statuses" :searchable="true"
                                         ...
                                         v-model.trim="form.status"></multiselect>
                        </b-form-group>
                    </div>
                    <div class="m-alert m-alert--icon alert alert-danger m-alert--square mb-0" role="alert" v-if="hasErrors">
                    ...
                    <div class="m-alert m-alert--icon alert alert-danger m-alert--square mb-0" role="alert" v-if="this.$v.form.$anyError">
                        <div class="m-alert__icon">
                            <i class="la la-warning"></i>
                        </div>
                        <div class="m-alert__text">
                    ...
                    <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions m-form__actions--solid">
                            <b-row>
                                <b-col>
                                    <button class="btn m-btn--pill btn-light  m-btn pull-left" @click="onReset" type="button"> Clear Form
                                    </button>
                                    <button class="btn btn-success m-btn--pill m-btn--icon pull-right m-btn--air" type="submit">
...
<script>
    ...
    import {error} from "../../../assets/vendors/sweetalert2/src/utils/utils";
